...
export default function CategoriesPanel() {
  ...
  const handleEdit = (category) => {
    ...
    if (category.isShared) {
      setMessage('This is a shared default category available to every company and can\'t be edited. Create your own category instead.')
      return
    }
  ...
  const handleDelete = async () => {
    ...
    if (deleteTarget.isShared) {
      setMessage('This is a shared default category available to every company and can\'t be deleted.')
      setDeleteTarget(null)
      return
    }
