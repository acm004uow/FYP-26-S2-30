        ...
        <form onSubmit={handleSave} className="mt-4">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1">
              ...
              <select value={dayOfWeek} onChange={e => setDayOfWeek(e.target.value)} className="w-full rounded-lg border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
          ...
          <div className="mt-4 flex justify-end">
            <button type="submit" disabled={saving} className="rounded-lg bg-gradient-to-r from-blue-500 to-green-500 px-5 py-3 text-sm font-semibold text-white disabled:opacity-60">
