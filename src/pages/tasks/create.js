...
const allStaff = [
  { id: 1, name: 'John Smith', role: 'Technician', skills: ['Maintenance', 'Repair'], available: true, rating: 4.8, tasks: 2, location: 'Zone A', workload: 2 },
  { id: 2, name: 'Sarah Lee', role: 'Inspector', skills: ['Inspection', 'Safety'], available: false, rating: 4.9, tasks: 4, location: 'Zone B', workload: 4 },
  { id: 3, name: 'Mike Chan', role: 'Operator', skills: ['Cleaning', 'Operation'], available: true, rating: 4.6, tasks: 1, location: 'Zone A', workload: 1 },
  { id: 4, name: 'Emma Wong', role: 'Coordinator', skills: ['Administration', 'Coordination'], available: true, rating: 4.7, tasks: 0, location: 'Zone C', workload: 0 },
  { id: 5, name: 'David Lim', role: 'Technician', skills: ['Maintenance', 'Electrical'], available: true, rating: 4.5, tasks: 3, location: 'Zone B', workload: 3 },
  { id: 6, name: 'Amy Tan', role: 'Cleaner', skills: ['Cleaning', 'Sanitizing'], available: true, rating: 4.8, tasks: 2, location: 'Office', workload: 2 },
]
...
export default function TaskCreation() {
  ...
  useEffect(() => {
    ...
    const prioritized = allStaff
      ...
      .map(s => {
        ...
        // Location proximity (mock: same zone gives +20)
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.assignee && recommendations.length > 0) {
      alert('Please select a staff member from recommendations.')
      return
    }
    setSubmitted(true)
    setTimeout(() => {
    ...
    <Layout role={role}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Fill in the details – our AI will recommend the best staff.</p>
        </div>
