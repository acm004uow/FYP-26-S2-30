...
const taskBarData = [
  ...
  { day: 'Wed', completed: 6, pending: 5 },
  { day: 'Thu', completed: 14, pending: 1 },
...
const recentTasks = [
  { id: 'T001', title: 'Equipment Maintenance', location: 'Building A', assignee: 'John Smith', status: 'In Progress', priority: 'High' },
  { id: 'T002', title: 'Safety Inspection', location: 'Warehouse B', assignee: 'Sarah Lee', status: 'Completed', priority: 'Medium' },
  { id: 'T003', title: 'Inventory Check', location: 'Store Room', assignee: 'Mike Chan', status: 'Pending', priority: 'Low' },
  { id: 'T004', title: 'Client Briefing', location: 'Conference Room', assignee: 'Emma Wong', status: 'In Progress', priority: 'High' },
]

const staffAvailability = [
  { name: 'John Smith', role: 'Technician', status: 'Available', tasks: 2, rating: 4.8 },
  { name: 'Sarah Lee', role: 'Inspector', status: 'Busy', tasks: 4, rating: 4.9 },
  { name: 'Mike Chan', role: 'Operator', status: 'Available', tasks: 1, rating: 4.6 },
  { name: 'Emma Wong', role: 'Coordinator', status: 'On Leave', tasks: 0, rating: 4.7 },
]
    ...
    <Layout role="manager">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            { label: 'Total Staff', value: '24', icon: Users, bg: 'bg-blue-50', text: 'text-blue-600', sub: '18 available today' },
            { label: 'Active Tasks', value: '38', icon: ClipboardList, bg: 'bg-green-50', text: 'text-green-600', sub: '12 due today' },
            { label: 'Completed', value: '55', icon: CheckCircle, bg: 'bg-purple-50', text: 'text-purple-600', sub: 'This week' },
            { label: 'Pending', value: '7', icon: Clock, bg: 'bg-orange-50', text: 'text-orange-600', sub: 'Need attention' },
          ].map(stat => (
