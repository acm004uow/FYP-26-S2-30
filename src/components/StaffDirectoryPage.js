...
import { AlertTriangle, Building2, ChevronDown, ChevronLeft, ChevronRight, MoreVertical, Phone, Search, Star, Users } from 'lucide-react'
import { supabase } from '../../lib/supabaseClient'
import { useAuthUser } from '../context/AuthUserContext'

// Below this share of max_weekly_hours, a staff member is flagged so the owner/manager knows to
// call them and find more work — per the Backend To Improve notes ("he call phone number... look
// for the job outside or plan it").
                ...
                {pagedStaffRows.map(staff => {
                  ...
                  return (
                    <tr key={staff.id} className="hover:bg-gray-50/60">
                      ...
                      <td className="px-5 py-4">
                        {staff.phone ? (
                          <a href={`tel:${staff.phone}`} className={`inline-flex items-center gap-1.5 text-gray-600 hover:underline ${theme.text}`}>
