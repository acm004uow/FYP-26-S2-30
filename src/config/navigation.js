...
export const navMap = {
  manager: [
    ...
    { name: 'Tasks', path: '/manager-tasks', icon: ListChecks },
    { name: 'Schedule', path: '/manager-schedule', icon: Calendar },
    { name: 'Leave Application', path: '/manager-time-off', icon: CalendarOff },
    ...
    { name: 'Feedback', path: '/manager-completed-tasks', icon: CheckCircle2 },
  ...
  departmentStaff: [
    ...
    { name: 'Leave Application', path: '/department-time-off', icon: CalendarOff },
  ],
  customer: [
  ...
  admin: [
    ...
    { name: 'Leave Application', path: '/admin?section=timeoff', icon: CalendarClock },
